            ...
            <div class="container px-4 px-lg-5 d-flex h-100 align-items-center justify-content-center">
                <div class="d-flex justify-content-center">
                    <div class="text-center">
                        ...
                        <h2 class="text-white mx-auto mt-2 mb-5"> Anda bisa mencari author novel apapun sesuai keinginan hati. 
                            Silahkan masukkan author yang anda inginkan! </h2>
                        <form class="d-flex">
                            <input type="text" class="form-control col-sm-1" name="cari" style="outline: none; width: 87%; background-color: white;" value="<?= @$_GET['cari']; ?>" name="email" placeholder="Masukkan author novel">
